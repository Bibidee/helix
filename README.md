...
v0.1.4 and v0.2.0 are historical. v0.3.0 is the current source-matched deployment at [`0x0bC80b70F87b493F12aBd27461666052a9FF8B57`](https://explorer-studio.genlayer.com/address/0x0bC80b70F87b493F12aBd27461666052a9FF8B57). It corrects unclear semantic dimensions to `INCONCLUSIVE`, derives replay identity from `delegation_id | manifest_hash`, removes the global lifetime action-cap denial of service, and treats invalid challenger counterevidence as a slashed challenge rather than a refunded veto. The deployed source matches SHA-256 `db673f3d7e905127505d2f5dde47fab8cb6381482f50932f78e61fcca7e1b65b` byte-for-byte.
