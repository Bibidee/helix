...
Fresh v0.5.1 evidence is recorded in [`docs/DEPLOYMENT.md`](docs/DEPLOYMENT.md): safe approval, blocked, inconclusive, replay rejection, and a finalized counterevidence-bearing challenge with its exact stored snapshot. Challenged re-review and safe consumption remain protocol-time-gated and are not claimed early.
