...
The v0.4.0 and v0.5.0 deployments are historical. v0.5.1 requires a fresh deployment after the nondeterministic challenge-admission fix; no v0.5.1 deployment is claimed until parity and live counterevidence admission are verified.
...
The v0.5.0 live evidence remains historical and is retained in [`docs/DEPLOYMENT.md`](docs/DEPLOYMENT.md); it is not evidence for v0.5.1.
