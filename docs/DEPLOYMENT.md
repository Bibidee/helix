...
Safe consumption, double-consumption rejection, challenged re-review, and final bond settlement were **TIME-GATED AT SUBMISSION** and are not claimed as live evidence. The opening window ended 25 Aug 2026 03:41:40 UTC; the settlement deadline was approximately 25 Aug 2026 09:41:40 UTC.

Known limitations: one lifetime challenge round per action; finer-grained attribution between challenger-controlled counterevidence availability and original-artifact availability remains future hardening.
