...
- Protocol-time-gated evidence still pending: challenged re-review/settlement for `safe-v050` (challenge opened at `2026-08-25T08:13:37Z`, opens after `2026-08-25T14:13:37Z`) and an independent safe2 consume/double-consume path (review transaction `0x19fa9ea4e4a5f4eaab93b0297f10bb40193fdc06091180d913273f0cc6f12e48` is still committing).
