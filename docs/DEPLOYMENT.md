...
The next release-evidence work is live safe, blocked, and challenge-path transactions. These must be recorded only after they actually finalize on StudioNet.
