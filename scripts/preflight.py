...
required = [
    ...
    '"version": "0.5.1"', "return verdict(left) == verdict(right)", "occurrence_nonce",
    ...
    "challenge_artifact_text", "def observe_challenge_artifact", "run_nondet_unsafe(leader, validator)", "refund_available_original_review_failure",
    ...
    "action_aliases", "int(expires_at) <= timestamp() + 2 * int(challenge_window)", "self.challenge_sink): raise",
]
