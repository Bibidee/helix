...
required = [
    ...
    '"version": "0.5.0"', "return verdict(left) == verdict(right)", "occurrence_nonce",
    ...
    "challenge_artifact_text", "fetch_verified(challenge_artifact_url", "refund_available_original_review_failure",
