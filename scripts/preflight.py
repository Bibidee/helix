...
ast.parse(source)
required = ["class Helix", "run_nondet_unsafe", "def fetch_verified", "hashlib.sha256", "challenge_bond_held", "settle_expired_challenge", "def is_actionable", "def canonical_hash(value)", '"version": "0.1.1"']
